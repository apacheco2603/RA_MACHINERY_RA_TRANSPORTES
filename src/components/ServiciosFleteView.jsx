...
export default function ServiciosFleteView() {
  return (
    <section id="servicios-transporte" className="py-24 bg-gray-50 border-t border-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        <div className="text-center max-w-3xl mx-auto mb-16">
          <span className="text-[#FFB700] font-bold tracking-widest uppercase text-sm mb-2 block">Catálogo de Soluciones</span>
          <h2 className="text-3xl md:text-4xl font-black text-black uppercase">Nuestros Servicios de Flete</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {servicios.map((servicio) => (
            <div 
              key={servicio.id} 
              className="bg-white p-8 rounded shadow-sm border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition duration-300 group"
            >
              <div className="w-16 h-16 bg-gray-100 rounded-full flex items-center justify-center mb-6 group-hover:bg-[#FFB700] transition duration-300">
                <servicio.icon className="w-8 h-8 text-black" />
              </div>
              <h3 className="text-xl font-black text-black mb-4 uppercase">{servicio.title}</h3>
